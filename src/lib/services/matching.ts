// ============================================
// Matching Service — DI factory pattern
// ============================================
...
export function createMatchingService(supabase: SupabaseClient) {
  return {
     ...
     * - Same city arrival: +3
     * - Same corridor (country-level): +1 (base)
     ...
     */
    async findMatchingListings(parcel: ParcelPosting): Promise<MatchResult[]> {
      ...
      if (error) {
        ...
        throw new ServiceError("Erreur lors de la recherche d'annonces", 'INTERNAL', error);
      }
     ...
     */
    async findMatchingParcels(listing: Listing): Promise<ParcelMatchResult[]> {
      ...
      if (error) {
        ...
        throw new ServiceError('Erreur lors de la recherche de colis', 'INTERNAL', error);
      }
