...
export default function CGU() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <h1 className="mb-8 text-3xl font-bold text-neutral-100">
      ...
      <div className="text-surface-100 max-w-none space-y-6 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">1. Objet</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">2. Inscription</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">3. Fonctionnement</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">4. Paiements</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">5. Responsabilités</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">6. Litiges</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">7. Propriété intellectuelle</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold text-neutral-100">8. Modification des CGU</h2>
          <p>
